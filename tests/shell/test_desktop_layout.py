...
class DesktopLayoutTests(unittest.TestCase):
    ...
    def test_topbar_is_backed_by_real_kde_models(self):
        ...
        self.assertIn('ListView', status_center)
        self.assertIn('MeoTheme.surfaceContainerHigh', status_center)
        ...
        self.assertIn('NotificationManager.Server.inhibited', status_center)
        self.assertIn('clearClosableNotifications()', status_center)
        self.assertIn('invokeAction', status_center)
