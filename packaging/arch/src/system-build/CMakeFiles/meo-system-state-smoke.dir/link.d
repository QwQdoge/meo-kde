meo-system-state-smoke: \
  ...
  /usr/lib/libKF6NetworkManagerQt.so.6.28.0 \
  /usr/lib/libKF6BluezQt.so.6.28.0 \
  /usr/lib/libKF6Solid.so.6.28.0 \
  /usr/lib/libKF6PulseAudioQt.so.1.8.1 \
  /usr/lib/libnm.so \
  ...
  /usr/lib/libimobiledevice-1.0.so.6 \
