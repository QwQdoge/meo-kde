...
meo-task-role-smoke: /usr/lib/Scrt1.o \
  /usr/lib/crti.o \
  /usr/lib/crtn.o \
  /usr/lib/libc.so \
  ...
  /usr/lib/libKF6ItemModels.so.6.28.0 \
  ...
  /usr/lib/libPlasma.so.7 \
  /usr/lib/libPlasmaActivities.so.7 \
  ...
  /usr/lib/libtaskmanager.so.6.7.3 \
  /usr/lib/libtdb.so.1 \
...
meo-task-role-smoke_autogen/mocs_compilation.cpp:
