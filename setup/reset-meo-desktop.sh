...
run rm -rf "${data_root}/plasma/plasmoids/org.meo.widgetexplorer"
run rm -rf "${data_root}/plasma/plasmoids/org.meo.widget.clock"
run rm -rf "${data_root}/plasma/plasmoids/org.meo.widget.media"
...
run rm -f "${data_root}/icons/hicolor/scalable/apps/meoarch-logo.svg"
...
run rm -f "${local_bin_root}/meo-system-monitor"
run rm -f "${local_bin_root}/meo-dock"
run rm -f "${data_root}/applications/org.meo.systemmonitor.desktop"
