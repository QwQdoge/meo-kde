...
PlasmoidItem {
    ...
    compactRepresentation: QQC2.AbstractButton {
        ...
        background: MeoShape { type: parent.hovered && !parent.down && !root.expanded ? "round" : "pill"; radius: parent.hovered && !parent.down && !root.expanded ? MeoTheme.shapeSmall : height / 2; color: parent.hovered || parent.down || root.expanded ? MeoTheme.surfaceContainerHighest : "transparent" }
